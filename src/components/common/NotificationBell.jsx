        ...
        <>
          ...
          <div className="absolute right-0 top-14 z-50 w-80 sm:w-96 bg-white border border-slate-200 rounded-2xl shadow-2xl shadow-slate-200/50 overflow-hidden">
            <div className="p-4 border-b border-slate-100 flex items-center justify-between bg-slate-50/50">
              <h3 className="text-sm font-extrabold text-slate-800 tracking-tight">Notifications</h3>
                  ...
                  >
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-[11px] text-slate-400 font-semibold mt-1.5">{timeAgo(notif.date_envoi)}</p>
                      </div>
                      {!notif.lu && (
